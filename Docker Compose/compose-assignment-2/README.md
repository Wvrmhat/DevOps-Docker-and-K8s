...
> When using mariadb, I had to add extra env variables so that a user is made as the database is created. Otherwise an error displays on the drupal database config page.
